...
struct OnboardingView: View {
    ...
    private let steps = [
        OnboardingStep(
            ...
            description: "Learn HTML and CSS through interactive lessons and earn XP as you progress!",
            icon: "sparkles",
            color: .appPrimary
        ),
        OnboardingStep(
        ...
        ZStack {
            ...
            VStack(spacing: 40) {
                ...
                HStack {
                    ...
                    .font(.headline)
                    .foregroundColor(.appBackground) // Contrast with background button color
                    .padding(.horizontal, 32)
                    .padding(.vertical, 12)
