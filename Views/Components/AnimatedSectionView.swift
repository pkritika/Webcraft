...
struct AnimatedSectionView: View {
    ...
    private var sectionHeader: some View {
        HStack(spacing: 16) {
            ...
            .accessibilityLabel(tts.isSpeaking ? "Stop reading aloud" : "Read section aloud")
            .accessibilityHint("Plays an audio recording of this lesson content")
        }
        .padding(20)
        .background(
            ...
            ForEach(Array(terms.enumerated()), id: \.offset) { idx, pair in
                ...
                VStack(alignment: .leading, spacing: 0) {
                    Button {
                        ...
                        HStack {
                            Text(pair.term)
                                ...
                                .foregroundColor(isExpanded ? accentColor : .textPrimary)
                            Spacer()
                    ...
                    if idx < terms.count - 1 {
                        Divider().background(Color.textPrimary.opacity(0.1)).padding(.horizontal, 16)
                    }
                }
            }
            .padding(.bottom, 4)
