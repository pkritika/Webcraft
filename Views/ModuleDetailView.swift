                    ...
                    GeometryReader { geo in
                        ZStack(alignment: .leading) {
                            ...
                            RoundedRectangle(cornerRadius: 4)
                                ...
                                .frame(width: geo.size.width * (lessons.isEmpty ? 0 : CGFloat(completedCount) / CGFloat(lessons.count)), height: 6)
                    ...
                    ForEach(Array(lessons.enumerated()), id: \.element.id) { idx, lesson in
                        ...
                        if idx < lessons.count - 1 {
                            ...
                            HStack {
                                ...
                                Rectangle()
                                    .fill(isCompleted ? accent.opacity(0.5) : Color.white.opacity(0.08))
...
private struct SubLessonRow: View {
    ...
    var body: some View {
        HStack(spacing: 16) {
            ...
            ZStack {
                Circle()
                    .fill(isCompleted ? accent : (isLocked ? Color.white.opacity(0.08) : accent.opacity(0.18)))
            ...
            VStack(alignment: .leading, spacing: 3) {
                ...
                Text(lesson.description)
                    .font(.system(size: 12))
                    .foregroundColor(.white.opacity(isLocked ? 0.2 : 0.5))
                    .lineLimit(2)
            }
